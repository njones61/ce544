...
![clay_liner.png](images/clay_liner.png)
...
Excel starter file: [clayliner.xlsx](files/clayliner.xlsx)<br>
Excel solution: [clayliner_key.xlsx](files/clayliner_key.xlsx) 
...
Excel starter file: [slurrywall.xlsx](files/slurrywall.xlsx)<br>
Excel solution: [slurrywall_KEY.xlsx](files/slurrywall_KEY.xlsx)
